...
public:
	RizinSleigh(LoadImage *ld, ContextDatabase *c_db): Rizinloader(ld), Sleigh(ld, c_db) {}
	~RizinSleigh() { clearCache(); }

	void reset(LoadImage *ld,ContextDatabase *c_db) { Rizinloader = ld; Sleigh::reset(ld, c_db); }
