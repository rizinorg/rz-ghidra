...
SleighInstructionPrototype *RzSleigh::getPrototype(SleighInstruction *context)
{
...
SleighInstruction *RzSleigh::getInstruction(Address &addr)
{
...
void RzSleigh::reconstructContext(ParserContext &protoContext)
{
	RzLoader->loadFill(protoContext.getBuffer(), 16, protoContext.getAddr());
...
SleighParserContext *RzSleigh::getParserContext(Address &addr, SleighInstructionPrototype *proto)
{
...
SleighParserContext *RzSleigh::newSleighParserContext(Address &addr, SleighInstructionPrototype *proto)
{
...
void RzSleigh::resolve(SleighParserContext &pos) const
{				// Resolve ALL the constructors involved in the
				// instruction at this address
	RzLoader->loadFill(pos.getBuffer(), 16, pos.getAddr());
...
void RzSleigh::generateLocation(const VarnodeTpl *vntpl, VarnodeData &vn, ParserWalker &walker)
{
...
void RzSleigh::generatePointer(const VarnodeTpl *vntpl, VarnodeData &vn, ParserWalker &walker)
{
...
VarnodeData RzSleigh::dumpInvar(OpTpl *op, Address &addr)
{
